...
Console.WriteLine("Введите количество строк массива1");
int rows1 = int.Parse(Console.ReadLine()!);

Console.WriteLine("Введите количество столбцов массива1");
int columns1 = int.Parse(Console.ReadLine()!);

int[,] arrayA = new int[rows1, columns1];

Console.WriteLine("Введите количество строк массива2");
int rows2 = int.Parse(Console.ReadLine()!);

Console.WriteLine("Введите количество столбцов массива2");
